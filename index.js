...
const piece11 = document.querySelector('.pos-1');
piece11.style.order = parseInt(Math.random() * 16) + 1;
const piece12 = document.querySelector('.pos-1');
piece12.style.order = parseInt(Math.random() * 16) + 1;
const piece13 = document.querySelector('.pos-1');
piece13.style.order = parseInt(Math.random() * 16) + 1;
const piece14 = document.querySelector('.pos-1');
piece14.style.order = parseInt(Math.random() * 16) + 1;
const piece15 = document.querySelector('.pos-1');
piece15.style.order = parseInt(Math.random() * 16) + 1;
const piece16 = document.querySelector('.pos-1');
